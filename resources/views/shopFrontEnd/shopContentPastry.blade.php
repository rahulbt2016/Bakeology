					...
					<div class="top-menu">
							...
							<nav class="link-effect-4" id="link-effect-4">
                              <ul>
								...
								<li><a data-hover="Cakes" href="{{ url('/shop') }}">Cakes</a></li>
								<li><a data-hover="Pastries" href="{{ url('/shop-pastry') }}">Pastries</a></li>
	...
	<div>
					<div class="features_items"><!--features_items-->
						...
						<?php
							...
							$products=Product::where('ProductCategory','pastry')->paginate(8);

							if(isset($_SESSION['email'])){
								foreach($products as $product){
									if($product->ProductAvailability=="yes" && $product->ProductCategory=="pastry" ){
