...
<!--start-home-->
	...
	<div>
					<div class="features_items"><!--features_items-->
						...
						<h2 style='font-size:32px;text-shadow: 0 0 3px #302D29, 0 0 5px #302D29;' class="title text-center">Cakes</h2>

						<?php
							use App\Product;

							$products=Product::where('ProductCategory','cake')->paginate(8);
							if(isset($_SESSION['email'])){
								foreach($products as $product){
									if($product->ProductAvailability=="yes" && $product->ProductCategory=="cake" ){
								...
								echo "<center>".$products->links()."</center>";
								echo "</div>";
							}
							else{
								foreach($products as $product){
